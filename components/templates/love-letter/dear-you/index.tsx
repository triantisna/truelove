...
function getGallery(content: Record<string, any>): GalleryItem[] {
...
export default function LoveLetter01({ website }: { website: WebsiteRecord }) {
  ...
  const reasons = useMemo(() => {
    const fromContent = content.reasons;

    if (
      Array.isArray(fromContent) &&
      fromContent.every((item) => typeof item === 'string')
    ) {
        ...
        <AnimatePresence mode="wait">
          {!opened ? (
            ...
            >
              ...
              >
                <span className="letter-kicker">A note for {receiverName}</span>
              ...
              <div className="memory-strip">
                {photos.length
                  ...
                  : [
                      ...
                      <motion.div
                        key={label}
                        className="memory-polaroid placeholder-polaroid"
                        whileHover={{
                          rotate: index % 2 ? 2 : -2,
                          y: -6,
                        }}
                ...
                <div className="reason-dots">
                  {reasons.map((_, index) => (
                    <button
                      ...
                      className={index === reasonIndex ? 'active' : ''}
              ...
              >
                ...
                <p>
                  And out of everyone in this world, I&apos;d still choose you.
                </p>
